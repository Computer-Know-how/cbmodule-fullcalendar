...
component persistent="true" table="cb_calendarEvent" {
	...
	// M2O -> Calendar
	property name="calendar" notnull="true" cfc="contentbox.modules_user.cbmodule-fullcalendar.model.Calendar" fieldtype="many-to-one" fkcolumn="FK_calendarID" lazy="true" fetch="join";
